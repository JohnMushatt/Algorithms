...
/**
 * Modify the find method of this class to use a linked list to locate a
 * repeater in an array, that is, a value which is duplicated at least n/2 + 1
...
public class FindRepeater extends TestCase {
	...
	public static int find(int[] array) {
		...
		int numofappearances = (arrlength / 2) + 1;
		int count = 1;
		...
		for (int val = 0; val < arrlength; val++) {
			count = 1;
			for (int value = val + 1; value < arrlength; value++) {
